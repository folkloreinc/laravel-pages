...
class Pages {
	...
	*/
	 ...
	 *
	 */
	public function uploadPicture($file,$params = array()) {
		...
		//Get destination
		$extensions = $this->app['config']->get('pages::pictures_mime_to_extension');
		$destinationPath = $this->app['config']->get('pages::pictures_path');
		$folder = date('Y-m-d');
